...
namespace SP.ProjectTaskWeb.Controllers
{
  ...
  [Authorize]
    ...
    public class WebController : ApiController
    {
        ...
        [Route("tasks")]
        [HttpGet]
        public IHttpActionResult GetProjectTasks([FromUri] string where = null, [FromUri] int count = 0, [FromUri] string sortBy = null, [FromUri] string groupBy = null, [FromUri] string pagingToken = null, [FromUri] string[] fields = null)
        {
            return GetDataResult<ProjectTask>(where, count, sortBy, groupBy, pagingToken, fields);
        }
        ...
        [Route("projects")]
        [HttpGet]
        public IHttpActionResult GetProjects([FromUri] string where = null, [FromUri] int count = 0, [FromUri] string sortBy = null, [FromUri] string groupBy = null, [FromUri] string pagingToken = null, [FromUri] string[] fields = null)
        {
            return GetDataResult<Project>(where, count, sortBy, groupBy, pagingToken, fields);
        }
        ...
        [Route("employees")]
        [HttpGet]
        public IHttpActionResult GetEmployees([FromUri] string where = null, [FromUri] int count = 0, [FromUri] string sortBy = null, [FromUri] string groupBy = null, [FromUri] string pagingToken = null, [FromUri] string[] fields = null)
        {
            return GetDataResult<Employee>(where, count, sortBy, groupBy, pagingToken, fields);
        }
        ...
        [Route("departments")]
        [HttpGet]
        public IHttpActionResult GetDepartments([FromUri] string where = null, [FromUri] int count = 0, [FromUri] string sortBy = null, [FromUri] string groupBy = null, [FromUri] string pagingToken = null, [FromUri] string[] fields = null)
        {
            return GetDataResult<Department>(where, count, sortBy, groupBy, pagingToken, fields);
        }
        ...
        public IHttpActionResult Retract()
        {
            try
            {
                using (ClientContext context = new Authentication.LowTrustTokenHelper(_tokenHelper).GetUserClientContext())
                {
                    ...
                    List list = projectTaskContext.List<ProjectTask>().GetSpList();
                    Helper.SetAppInstalled(list, false);
          ...
          where TEntity : ListItemEntity, new()
        {
            ...
            public void Load(ClientContext context, string where = null, int count = 0, string sortBy = null, string groupBy = null, string pagingToken = null, string[] fields = null)
            {
                string nextToken;
                bool canCreate;
                Items = GetItems(context, where, count, sortBy, groupBy, pagingToken, fields, out nextToken, out canCreate);
                NextToken = nextToken;
