...
namespace SP.ProjectTaskWeb
{
    ...
    public static class UnityConfig
    {
        ...
        {
            container.RegisterSingleton<LowTrustAuthenticationParameters, Authentication.LowTrustAuthenticationParameters>();
            ...
            container.RegisterType<ISharePointSessionProvider, Authentication.SharePointSessionProvider>(new HierarchicalLifetimeManager());
