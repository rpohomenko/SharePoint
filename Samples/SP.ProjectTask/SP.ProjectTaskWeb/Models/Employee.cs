...
namespace SP.ProjectTaskWeb.Models
{
    ...
    public class Employee : Entity
    {
        ...
        [UserField("pt_Account", Title = "Account", Order = 3, UserSelectionMode = FieldUserSelectionMode.PeopleOnly, Indexed = true, EnforceUniqueValues = true)]
        public FieldLookupValue AccountLookup
        {
            get;
        }
        ...
        public int[] Position
        {
            get
            {
                if (EmployeePosition == EmployeePosition.None) return null;
                return EmployeePosition.ToString()
                    .Split(new string[] { ", " }, StringSplitOptions.None)
                    .Select(i => (int)Enum.Parse(EmployeePosition.GetType(), i)).ToArray();
            }
            set
            {
        ...
        //[DataMember]
        //[ChoiceField(Name = "pt_Position", Title = "Position", Order = 3, IsMultiple = true)]
        //public ICollection<string> Position
        //{
        //  get;
        //  set;
        //}
