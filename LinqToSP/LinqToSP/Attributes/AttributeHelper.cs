            ...
            where TEntity : class, IListItemEntity, new()
        {
            if (entity != null)
                foreach (var property in typeof(TEntity).GetProperties())
                {
                    ...
                    if (att != null)
                    {
                        if (property.CustomAttributes.Any(attr => attr.AttributeType == typeof(RemovedFieldAttribute))) continue;
                    ...
                    else
                    {
                        foreach (var p in typeof(TEntity).GetInterfaces().SelectMany(i => i.GetProperties()))
                        {
                            if (p.Name == property.Name)
                            {
                                ...
                                if (att != null)
                                {
                                    if (p.CustomAttributes.Any(attr => attr.AttributeType == typeof(RemovedFieldAttribute))) continue;
            ...
            where TEntity : class, IListItemEntity, new()
        {
            if (entity != null)
                foreach (var field in typeof(TEntity).GetFields())
                {
                    ...
                    if (att != null)
                    {
                        if (field.CustomAttributes.Any(attr => attr.AttributeType == typeof(RemovedFieldAttribute))) continue;
                    ...
                    else
                    {
                        foreach (var f in typeof(TEntity).GetInterfaces().SelectMany(i => i.GetFields()))
                        {
                            if (f.Name == field.Name)
                            {
                                ...
                                if (att != null)
                                {
                                    if (f.CustomAttributes.Any(attr => attr.AttributeType == typeof(RemovedFieldAttribute))) continue;
